...
function mapProgress(
  ...
  return {
    ...
    run_id: runId,
    mode: current?.requested_by ?? 'scheduled',
    query_id: null,
    query_name: null,
    posts_traversed: counts.posts_traversed,
    posts_added: counts.posts_added,
    posts_skipped: counts.posts_skipped,
    files_already_in_library: counts.files_already_in_library,
...
function mapRun(run: SubscriptionRunSummary): SubscriptionRunRecord {
  return {
    ...
    posts_skipped: run.counts.posts_skipped,
    files_already_in_library: run.counts.files_already_in_library,
...
export function getSubscriptionProgress(
  ...
  return invoke<CurrentSubscriptionProgress | null>('subscriptions.progress.get', {
    ...
    mode: current.requested_by,
    query_id: null,
    query_name: null,
    posts_traversed: current.counts.posts_traversed,
    posts_added: current.counts.posts_added,
    posts_skipped: current.counts.posts_skipped,
    files_already_in_library: current.counts.files_already_in_library,
