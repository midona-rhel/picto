...
export type { SetFolderWatchConfigInput } from './SetFolderWatchConfigInput';
export type { ClearFolderWatchConfigInput } from './ClearFolderWatchConfigInput';
export type { DeleteFolderInput } from './DeleteFolderInput';
export type { UpdateFolderParentInput } from './UpdateFolderParentInput';
export type { AddFilesToFolderInput } from './AddFilesToFolderInput';
...
export type { CreateGroupInput } from './CreateGroupInput';
export type { DeleteGroupInput } from './DeleteGroupInput';
export type { RenameGroupInput } from './RenameGroupInput';
export type { SetGroupScheduleInput } from './SetGroupScheduleInput';
export type { RunGroupInput } from './RunGroupInput';
export type { StopGroupInput } from './StopGroupInput';
...
import type { SetFolderWatchConfigInput } from './SetFolderWatchConfigInput';
import type { ClearFolderWatchConfigInput } from './ClearFolderWatchConfigInput';
import type { DeleteFolderInput } from './DeleteFolderInput';
import type { UpdateFolderParentInput } from './UpdateFolderParentInput';
import type { AddFilesToFolderInput } from './AddFilesToFolderInput';
...
import type { DeleteGroupInput } from './DeleteGroupInput';
import type { RenameGroupInput } from './RenameGroupInput';
import type { SetGroupScheduleInput } from './SetGroupScheduleInput';
import type { RunGroupInput } from './RunGroupInput';
import type { StopGroupInput } from './StopGroupInput';
...
export interface TypedCommandMap {
  ...
  set_folder_watch_config: { input: SetFolderWatchConfigInput; output: null };
  ...
  // subscriptions
  get_groups: { input: Record<string, never>; output: unknown };
  create_group: { input: CreateGroupInput; output: unknown };
  delete_group: { input: DeleteGroupInput; output: null };
  rename_group: { input: RenameGroupInput; output: null };
  set_group_schedule: { input: SetGroupScheduleInput; output: null };
  run_group: { input: RunGroupInput; output: null };
  stop_group: { input: StopGroupInput; output: null };
