...
## Completion Note
Implemented as part of the typed dispatch and lifecycle consolidation work. The separate `files_review` dispatch module and its commands no longer exist; inbox review behavior now flows through `./core/src/dispatch/typed/files_lifecycle.rs`.
