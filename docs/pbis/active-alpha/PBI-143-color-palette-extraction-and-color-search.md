...
Evidence:
1. reference application has automatic color palette extraction, color-based filtering (DeltaE 2000), find similar color items, re-analyze colors, copy color from palette.
