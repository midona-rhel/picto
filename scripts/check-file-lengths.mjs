...
const EXCEPTION_BUDGETS = {
  ...
  'src/components/image-grid/imageAtlas.ts': { limit: 900, phase: 'P1', reason: 'legacy hotspot' },
  'src/components/tags/TagSelectPanel.tsx': { limit: 900, phase: 'P1', reason: 'legacy hotspot' },
  'src/components/image-grid/ImageGrid.tsx': { limit: 2400, phase: 'P1', reason: 'legacy hotspot' },
  'src/components/image-grid/CanvasGrid.tsx': { limit: 2100, phase: 'P1', reason: 'legacy hotspot' },
  'src/components/image-grid/VirtualGrid.tsx': { limit: 1200, phase: 'P1', reason: 'legacy hotspot' },
