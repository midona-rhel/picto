...
import { GridViewMode } from './components/image-grid/ImageGrid';
import { ImageGridControls } from './components/image-grid/ImageGridControls';
import { FilterBar } from './components/image-grid/FilterBar';
import { ImagePropertiesPanel } from './components/image-grid/ImagePropertiesPanel';
import { MainViewRouter, CreateFlowModal } from './components/layout/MainViewRouter';
import { WindowControls } from './components/layout/WindowControls';
import { Sidebar } from './components/sidebar/Sidebar';
import { SidebarMenuButton } from './components/sidebar/SidebarMenuButton';
import { DragGhost } from './components/image-grid/DragGhost';
import { TagPickerPortal } from './services/TagPickerPortal';
import { TagSelectPortal } from './components/tags/TagSelectPanel';
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.mainContent}>
          ...
          <MainViewRouter
            ...
            gridTargetSize={gridTargetSize}
            gridSortField={gridSortField}
            gridSortOrder={gridSortOrder}
            effectiveSearchTags={grid.effectiveSearchTags}
            excludedSearchTags={grid.excludedSearchTags}
            ...
            flowRefreshToken={flowRefreshToken}
