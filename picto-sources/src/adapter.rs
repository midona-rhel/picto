...
use crate::{
    DiscoveryBatch, DiscoveryRequest, HttpRuntime, RequestCredentials, SourceError,
    SourcePartition, SourcePost,
};
...
impl ProviderRegistry {
    pub fn native() -> Self {
        ...
        registry.register(crate::providers::coomer::adapter());
        ...
        registry.register(crate::providers::kemono::adapter());
