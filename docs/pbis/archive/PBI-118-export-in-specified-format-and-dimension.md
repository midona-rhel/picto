...
Evidence:
1. reference application has Shift+E for batch convert and export to target format with custom dimensions.
2. reference application also has Cmd+E for basic export to computer.
