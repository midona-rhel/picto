  ...
  build: {
    rollupOptions: {
      ...
      input: {
        ...
        "flash-thumbnail": resolve(__dirname, "flash-thumbnail.html"),
        "pdf-thumbnail": resolve(__dirname, "pdf-thumbnail.html"),
        "document-thumbnail": resolve(__dirname, "document-thumbnail.html"),
      },
    },
  },
