...
import { folderNodesAtom, smartFoldersAtom, smartFolderCountsAtom, scopeCountsAtom } from '../state/sidebar';
...
function App() {
  ...
  // --- Sidebar data (Jotai atoms) ---
  const { active: allActiveCount, inbox: inboxCount, uncategorized: uncategorizedCount, trash: trashCount, untagged: untaggedCount } = useAtomValue(scopeCountsAtom);
