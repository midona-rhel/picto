 ...
 */
export type ActivityCounts = { posts_traversed: number, posts_added: number, posts_skipped: number, files_already_in_library: number, fetched: number, downloaded: number, queued: number, ingested: number, failed: number, deleted: number, };
