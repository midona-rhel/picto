...
Evidence:
1. reference application inspector shows: folder membership list, extracted color palette (with copy/find similar), EXIF camera info, source URL, multi-selection batch inspector.
