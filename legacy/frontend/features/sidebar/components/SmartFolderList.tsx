...
import { smartFoldersAtom, smartFolderCountsAtom } from '../../../state/sidebar';
...
export function SmartFolderList({ onFolderUpdated }: SmartFolderListProps) {
  const domainFolders = useAtomValue(smartFoldersAtom);
  const counts = useAtomValue(smartFolderCountsAtom);
