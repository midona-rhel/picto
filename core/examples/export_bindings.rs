...
fn main() {
    ...
    use picto_core::ipc_v2::{
        ...
        QueryItemsInput, RenameFolderInput, RenameSubscriptionInput, RenameTagInput,
        ...
        TagInput, TargetInput, UpdateSmartFolderInput, UpdateSubscriptionQueryInput, ValueInput,
    };
