    ...
    <div className={styles.controls} onClick={(e) => e.stopPropagation()}>
      ...
      <div className={styles.buttonRow}>
        ...
        <div className={styles.buttonRowRight}>
          ...
          <KbdTooltip label={state.loop ? 'Loop on' : 'Loop off'} shortcut="L">
